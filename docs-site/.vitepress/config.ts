      ...
      '/user_manual/': [
        {
          ...
          items: [
            ...
            { text: '3. Making a sale',               link: '/user_manual/03-making-a-sale' },
            { text: '4. Taking payment',              link: '/user_manual/04-payment' },
            { text: '5. Receipts',                    link: '/user_manual/05-receipts' },
            { text: '6. Customers',                   link: '/user_manual/06-customers' },
            { text: '7. Discounts',                   link: '/user_manual/07-discounts' },
            { text: '8. Hold bills',                  link: '/user_manual/08-hold-bills' },
            { text: '9. End of day — Z-Report',       link: '/user_manual/09-end-of-day' },
            { text: '10. Reports',                    link: '/user_manual/10-reports' },
            { text: '11. Barcode & label printing',   link: '/user_manual/11-barcode-labels' },
            { text: '12. Settings',                   link: '/user_manual/12-settings' },
          ],
        },
      ],
    },
