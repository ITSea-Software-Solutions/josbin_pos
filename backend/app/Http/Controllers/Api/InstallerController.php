...
/**
 * Serves the POS desktop installer from the server the dashboard runs on.
 *
...
class InstallerController extends Controller
{
     ...
     * resumes instead of restarting 100+ MB.
     */
    ...
    /**
     * Newest *.exe in the configured directory. Newest-wins means dropping an
     * updated build in the folder is the whole "release" procedure — no config
     * edit, no restart.
     */
    private function resolveInstaller(): ?string
    {
