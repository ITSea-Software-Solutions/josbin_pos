...
/**
 * Renders a bright "DEMO MODE" bar across the top of the dashboard when the
 * backend reports it is running on the demo stack
 * (JOSBIN_POS_DEMO_MODE=true in backend/.env, set by docker-compose.demo.yml).
 *
 * Fetches public /api/environment on mount. No auth needed, so the banner
 * shows on the login screen too.
 */
