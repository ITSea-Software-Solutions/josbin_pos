...
export interface CreateSalePayload {
  ...
  // that does not pay the tax. The backend strips the BTW component from
  // every price and REQUIRES the reason (min 5 chars) for the audit trail.
  btw_exempt?: boolean
  btw_exempt_reason?: string
