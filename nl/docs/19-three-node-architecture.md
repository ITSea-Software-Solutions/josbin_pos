...
eigen database, its own installation and its own reason to exist. They talk over
...
<svg viewBox="0 0 700 380" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Three nodes: shop node in the shop, control plane in the cloud, tax node at the Belastingdienst, with licence, sync and filing arrows between them" style="max-width:700px;width:100%;height:auto;font-family:sans-serif">
  ...
  <text x="120" y="176" text-anchor="middle" font-size="14" font-weight="700" fill="#111827">🏪 Winkelknooppunt</text>
  ...
  <text x="120" y="224" text-anchor="middle" font-size="11.5" fill="#111827">kassa’s · verkopen · assortiment</text>
  <text x="120" y="242" text-anchor="middle" font-size="11.5" fill="#111827">kassa-sessies · klanten</text>
  <text x="120" y="260" text-anchor="middle" font-size="11.5" fill="#111827">eigen gebruikers</text>
  <rect x="36" y="274" width="168" height="24" rx="6" fill="#e9f7ef"/>
  <text x="120" y="291" text-anchor="middle" font-size="11" fill="#1d7a46">✅ verkoopt zonder internet</text>
  <text x="120" y="316" text-anchor="middle" font-size="10.5" fill="#6b7280">geen beheer- of licentiecode</text>

  <!-- Control plane -->
  <rect x="265" y="40" width="180" height="150" rx="12" fill="#293371"/>
  <text x="355" y="66" text-anchor="middle" font-size="14" font-weight="700" fill="#ffffff">☁️ Beheerknooppunt</text>
  ...
  <text x="355" y="113" text-anchor="middle" font-size="11.5" fill="#ffffff">organisaties · licenties</text>
  <text x="355" y="131" text-anchor="middle" font-size="11.5" fill="#ffffff">vloot · geconsolideerd overzicht</text>
  <text x="355" y="149" text-anchor="middle" font-size="11.5" fill="#ffffff">ondertekent licentietokens 🔑</text>
  <text x="355" y="173" text-anchor="middle" font-size="10.5" fill="#c9d2ee">privésleutel verlaat dit nooit</text>

  <!-- Tax node -->
  <rect x="490" y="150" width="190" height="180" rx="12" fill="#ffffff" stroke="#1f6b3b" stroke-width="2.5"/>
  <text x="585" y="176" text-anchor="middle" font-size="14" font-weight="700" fill="#0e1a14">🏛 Belastingknooppunt</text>
  ...
  <text x="585" y="224" text-anchor="middle" font-size="11.5" fill="#0e1a14">alleen BTW-aangiftes</text>
  <text x="585" y="242" text-anchor="middle" font-size="11.5" fill="#0e1a14">eigen database</text>
  <text x="585" y="260" text-anchor="middle" font-size="11.5" fill="#0e1a14">overzicht over organisaties</text>
  <rect x="506" y="274" width="158" height="24" rx="6" fill="#e6efe9"/>
  <text x="585" y="291" text-anchor="middle" font-size="11" fill="#1f6b3b">geen commerciële gegevens</text>
  ...
  <text x="150" y="128" font-size="11" font-weight="600" fill="#EF6C00">ondertekende licentie 🔑</text>
  <text x="150" y="142" font-size="10" fill="#6b7280">activering + verlenging</text>
  ...
  <text x="354" y="292" text-anchor="middle" font-size="11" font-weight="600" fill="#1f6b3b">BTW-aangifte, ondertekend door de winkel</text>
  <text x="354" y="318" text-anchor="middle" font-size="10" fill="#6b7280">rechtstreeks — het beheerknooppunt zit niet in de bewijsketen</text>
  ...
  <text x="470" y="96" font-size="10" fill="#6b7280">alleen ontvangstbevestiging</text>
  <text x="470" y="108" font-size="10" fill="#6b7280">ingediend j/n · ref · wanneer</text>
</svg>
...
| **Sync** | shop → control | Sale totalen, Z-rapporten, register events | When available; queues when not |
...
**Control plane** — u host dit zelf, one instance.
...
BTW filings and nothing else, in its eigen database. It never holds a shop's
...
- Editing the token in the shop's eigen database breaks the signature.
...
## 19.5 Wat bewust geen enkele verbinding oversteekt
